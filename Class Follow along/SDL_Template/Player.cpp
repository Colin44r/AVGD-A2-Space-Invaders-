...
Player::Player() {
	...
	AddCollider(new BoxCollider(Vector2(16.0f, 67.0f)), Vector2(18.0f, 10.0f));
	AddCollider(new BoxCollider(Vector2(16.0f, 67.0f)), Vector2(-18.0, 10.0f));
...
void Player::Hit(PhysEntity* other) {
	...
	mAudio->PlaySFX("SFX/PlayerExplosion");
	mWasHit = true;
}
